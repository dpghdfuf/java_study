    ...
    public static void main(String[] args) {
        ...
        try {
            if ("q".equalsIgnoreCase(selectedMenu)) {
                ...
                throw new IndexOutOfBoundsException("예외 강제로 생성"); // throw new IndexoutOfBoundsException("예외 강제로 생성");처럼
            ...
            e.printStackTrace();
            System.out.println(e.getErrorMap()); // getter가 있어서 안에 멤버변수를 가져오는 것이다.
        } catch (Exception e) {
